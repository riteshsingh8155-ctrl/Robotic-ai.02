...
# ===== CONFIG =====
TELEGRAM_TOKEN = "BOT_TOKEN_YAHAN_DALO"
TELEGRAM_CHAT_ID = "CHAT_ID_YAHAN_DALO"
...
def make_ohlcv(n, freq, start="2026-01-01", trend=0.0002, vol=0.001):
    ...
    return pd.DataFrame({"Open": open_, "High": high, "Low": low, "Close": close, "Volume": vol_col}, index=idx)
